package com.project.emailUtils;
...
public class EmailSender {
	...
	public static void sendWelcomeMessage() throws FileNotFoundException {
		...
		try {
			...
			message.setText("!!!!!!!!!!!!!Application Successfully Started!!!!!!!!!!!!!");
			sendMail(message);
		} catch (AddressException e) {
			e.printStackTrace();
		} catch (MessagingException e) {
	...
	public static void sendTestMessage() throws FileNotFoundException {
		...
		try {
			...
			message.setText("!!!!!!!!!!!!!Application Running!!!!!!!!!!!!!");
			sendMail(message);
		} catch (AddressException e) {
			e.printStackTrace();
		} catch (MessagingException e) {
	...
	public static void sendStockStatusMessage(String LINK, float currentPrice) {
		...
		try {
			...
			message.setText("BINGO !!!! Product came back in stock..  ");
			sendMail(message);
		} catch (AddressException e) {
			e.printStackTrace();
		} catch (MessagingException e) {
	...
	public static void sendRestartMessage() throws FileNotFoundException {
		...
		try {
			...
			message.setText("!!!!!!!!!!!!!Price Tracker Successfully Restarted!!!!!!!!!!!! items being tracked");
			sendMail(message);
		} catch (AddressException e) {
			e.printStackTrace();
		} catch (MessagingException e) {
